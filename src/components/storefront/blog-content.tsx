...
export function BlogContent({ content }: { content: string }) {
  ...
  return (
    <div className="prose prose-lg max-w-none prose-headings:font-display prose-headings:text-navy prose-headings:mt-6 prose-headings:font-bold prose-a:text-gold-deep prose-strong:text-navy prose-blockquote:border-l-gold prose-blockquote:bg-cream/60 prose-blockquote:py-2 prose-blockquote:px-4 prose-blockquote:rounded-r prose-li:my-1 prose-table:border-collapse prose-th:bg-cream/60 prose-th:text-navy prose-th:px-3 prose-th:py-2 prose-td:px-3 prose-td:py-2 prose-td:border prose-th:border prose-img:rounded-lg">
      <ReactMarkdown
        components={{
          ...
          blockquote: ({ node, ...props }) => <blockquote className="border-l-4 border-gold bg-cream/60 py-2 px-4 rounded-r-md my-4 italic text-foreground/70" {...props} />,
