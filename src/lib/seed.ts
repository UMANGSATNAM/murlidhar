      ...
      attributes: [
        {
          name: 'Card Type',
          options: [
            'GOLD FOIL 350 GSM CARD SINGLE FOIL FB',
            '400GSM roundcut DRIFFOFF UV (SINGLE/FB)',
            'NON TEREBAL SINGLE OR FRONT BACK (WITH COTING)',
            'DRIPOFF_NT_SINGLE',
            'DRIPOFF_NT_FRONTBACK',
            'NON TEREBAL SINGLE SIDE',
            'NONTEREBAL FRONT BACK',
            'ARTCARD SINGLE SIDE(250GSM)',
            'ARTCARD F B WITHLAMINATION(250GSM)',
            'Artcard Front Back Without(300GSM)',
            'MATT CARD (350GSM)',
            'MATTUV_370GSM_SINGLEUV_FRONTBACK PRINTIN',
            'MATTUV_370GSM_FB_FRONTBACK UV',
            'MATT TEXTURE (350GSM)',
            'ARTCARD_SINGLE SIDE LAMINATION(250GSM)',
            '350GSM FBB BOARD (SINGLE SIDE)',
          ],
        },
...
function buildBusinessCardVariants(): SeedVariant[] {
  ...
  const basePrices: Record<string, number> = {
    'GOLD FOIL 350 GSM CARD SINGLE FOIL FB': 450,
    '400GSM roundcut DRIFFOFF UV (SINGLE/FB)': 380,
    'NON TEREBAL SINGLE OR FRONT BACK (WITH COTING)': 280,
    'DRIPOFF_NT_SINGLE': 300,
    'DRIPOFF_NT_FRONTBACK': 420,
    'NON TEREBAL SINGLE SIDE': 220,
    'NONTEREBAL FRONT BACK': 340,
    'ARTCARD SINGLE SIDE(250GSM)': 180,
    'ARTCARD F B WITHLAMINATION(250GSM)': 280,
    'Artcard Front Back Without(300GSM)': 240,
    'MATT CARD (350GSM)': 320,
    'MATTUV_370GSM_SINGLEUV_FRONTBACK PRINTIN': 360,
    'MATTUV_370GSM_FB_FRONTBACK UV': 480,
    'MATT TEXTURE (350GSM)': 380,
    'ARTCARD_SINGLE SIDE LAMINATION(250GSM)': 220,
    '350GSM FBB BOARD (SINGLE SIDE)': 200,
  }
