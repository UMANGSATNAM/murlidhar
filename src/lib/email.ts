...
export function orderConfirmationHtml(opts: {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#faf6ed;padding:24px;border:1px solid #e3d9c2">
    ...
    <div style="margin-top:24px;padding-top:16px;border-top:2px solid #0d9488;font-size:12px;color:#666;text-align:center">
...
export function statusUpdateHtml(opts: {
  ...
  <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#faf6ed;padding:24px;border:1px solid #e3d9c2">
    ...
    <p style="text-align:center;margin:24px 0">
      <span style="display:inline-block;background:#0d9488;color:#0f1b33;padding:10px 24px;border-radius:24px;font-weight:bold;text-transform:uppercase;letter-spacing:1px">${opts.status}</span>
    </p>
